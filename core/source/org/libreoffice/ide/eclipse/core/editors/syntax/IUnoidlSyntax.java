...
public interface IUnoidlSyntax {
     ...
     */
    public static final String[] RESERVED_WORDS = { "published", //$NON-NLS-1$
        "get", //$NON-NLS-1$
        "set", //$NON-NLS-1$
        "service", //$NON-NLS-1$
        "singleton", //$NON-NLS-1$
     ...
     */
    public static final String[] MODIFIERS = { "bound", //$NON-NLS-1$
     ...
     * UNO-IDL constants.
     */
    public static final String[] CONSTANTS = { "TRUE", //$NON-NLS-1$
        "True", //$NON-NLS-1$
        "FALSE", //$NON-NLS-1$
        "False" //$NON-NLS-1$
    };
     ...
     * UNO-IDL types.
     */
    public static final String[] TYPES = { "string", //$NON-NLS-1$
        "short", //$NON-NLS-1$
        "long", //$NON-NLS-1$
        "byte", //$NON-NLS-1$
        "hyper", //$NON-NLS-1$
