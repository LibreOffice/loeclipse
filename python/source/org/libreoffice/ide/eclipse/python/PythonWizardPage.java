/*************************************************************************
 *
 * $RCSfile: PythonWizardPage.java,v $
 *
 * $Revision: 1.5 $
 *
 ...
 */
public class PythonWizardPage extends LanguageWizardPage {
     ...
     * Constructor.
     */
    public PythonWizardPage() {
        super();
        setImageDescriptor(OOoJavaPlugin.getDefault().getImageRegistry().getDescriptor(OOoJavaPlugin.WIZBAN));
        setTitle(Messages.getString("PythonWizardPage.PageTitle")); //$NON-NLS-1$
        setDescription(Messages.getString("PythonWizardPage.PageDescription")); //$NON-NLS-1$
    }
    ...
    public void createControl(Composite pParent) {
        ...
        mJavaTestsRow = new BooleanRow(body, JAVA_TESTS,
            Messages.getString("PythonWizardPage.IncludeTestClasses")); //$NON-NLS-1$
